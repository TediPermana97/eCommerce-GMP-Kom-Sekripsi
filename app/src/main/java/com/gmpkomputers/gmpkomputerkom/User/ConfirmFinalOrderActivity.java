package com.gmpkomputers.gmpkomputerkom.User;
...
import com.gmpkomputers.gmpkomputerkom.Model.Cart;
import com.gmpkomputers.gmpkomputerkom.Model.User;
...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    Button addAdress, confirmOder,button_bayar;
...
//    String userid, username, userphone, useraddress, sellerid, productid, productimageUrl, productprice, quantity, paymentmode, status, totalamount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_bayar = (Button)findViewById(R.id.button_bayar);

        button_bayar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent pindah = new Intent(ConfirmFinalOrderActivity.this, MainActivity.class);
