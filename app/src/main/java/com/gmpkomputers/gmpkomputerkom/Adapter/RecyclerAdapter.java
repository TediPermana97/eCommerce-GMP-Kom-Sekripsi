package com.gmpkomputers.gmpkomputerkom.Adapter;
...
import com.gmpkomputers.gmpkomputerkom.Model.Teacher;
...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public void search( List<Teacher> teachers12)
    {
        teachers=new ArrayList<>();
        teachers.addAll(teachers12);
